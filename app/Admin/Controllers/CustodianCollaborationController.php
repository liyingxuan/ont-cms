...
class CustodianCollaborationController extends Controller
{
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Collaboration');
            $content->description('用来管理Custodian上有合作意向的留言信息。');

            $content->breadcrumb(
                ['text' => 'Custodian', 'url' => ''],
                ['text' => 'Collaboration', 'url' => '/custodian/collaboration'],
                ['text' => '申请列表']
            );
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('处理Collaboration');
    ...
    {
        return Admin::grid(CustodianCollaboration::class, function (Grid $grid) {
    ...
    {
        return Admin::form(CustodianCollaboration::class, function (Form $form) {
